  ...
  try {
    ...
    const gpt4Completion = await openai.chat.completions.create({
      ...
      messages: [
        ...
        { role: 'system', content: "You only return in JSON a coordinates key with a value in this format [27.952104, -82.457427], then a title of the location with a title key" },
